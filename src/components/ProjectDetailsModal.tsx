...
const ProjectDetailsModal = ({ projectDetails }: any | undefined ) => {
    const sliderRef: any | undefined = useRef();
                  ...
                  <div className="col-md-7">
                    <Slider {...settings} ref={sliderRef}>
                      ...
                      {projectDetails?.sliderImages?.length > 0 &&
                        projectDetails?.sliderImages?.map((image: string | undefined, index: React.Key | null | undefined) => (
